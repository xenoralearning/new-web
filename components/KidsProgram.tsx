...
const KidsProgram: React.FC<KidsProgramProps> = ({ onNavigate }) => {
  ...
  return (
    ...
    <section id="kids" className="relative py-16 sm:py-20 md:py-24 lg:py-32 xl:py-40 2xl:py-48 px-4 sm:px-6 lg:px-12 xl:px-16 z-20 bg-slate-50 dark:bg-black/20 w-full mb-16 sm:mb-20 lg:mb-24 xl:mb-32">
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-16 xl:gap-24 items-center">
        ...
        {/* Content (~62%) - Enhanced desktop spacing */}
        <div className="lg:col-span-7 order-2 lg:order-1">
          <Reveal>
            <div className="p-6 sm:p-8 lg:p-12 xl:p-16 rounded-3xl lg:rounded-4xl bg-white dark:bg-xenora-800 border border-purple-200 dark:border-purple-500/30 shadow-2xl relative overflow-hidden">
               ...
               <p className="text-base sm:text-lg lg:text-xl xl:text-2xl text-slate-700 dark:text-slate-300 mb-6 sm:mb-8 lg:mb-10 xl:mb-12 leading-relaxed">
                 {t.description}
               </p>
               
               <ul className="space-y-3 sm:space-y-4 lg:space-y-5 xl:space-y-6 mb-6 sm:mb-8 lg:mb-10 xl:mb-12">
                  {t.list.map((item, i) => (
                      <li key={i} className="flex items-center gap-3 lg:gap-4 text-sm sm:text-base lg:text-lg xl:text-xl text-slate-600 dark:text-slate-400">
                          <div className="w-2 h-2 lg:w-3 lg:h-3 rounded-full bg-purple-500 shadow-[0_0_10px_rgba(168,85,247,0.5)] flex-shrink-0"></div>
               ...
               <button 
                  ...
                  className="w-full py-4 lg:py-5 xl:py-6 rounded-xl lg:rounded-2xl bg-purple-600 hover:bg-purple-700 text-white font-bold text-base lg:text-lg xl:text-xl transition-all shadow-lg shadow-purple-500/20 hover:scale-105 active:scale-95 min-h-[48px] lg:min-h-[56px] xl:min-h-[64px]"
